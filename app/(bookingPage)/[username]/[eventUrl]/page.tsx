import { CreateEventTypeAction, CreateMeetingAction } from "@/app/actions";
            ...
            {showForm ?(
                ...
                <CardContent className="p-5 md:grid md:grid-cols-[1fr,auto,1fr] gap-4">
                    <div>
                        ...
                        src={data.User?.image as string} alt="Profile Image of User"
                         />
                ...
                <Input name="name" placeholder="Your Name"/>
                        ...
                        <Input name="email" placeholder="example@ex.com"/>
                        </div>
